...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const onSubmit = async (data: ProductFormValues) => {
    try {
      ...
      if (initialData) {
        await axios.put(
          `/api/shipments/edit-shipment/${initialData._id}`,
          data,
        );
      } else {
        await axios.post(`/api/shipments/create-shipment`, data);
        toast({
          variant: "default",
          title: "Shipmentt created",
          description: "Shipment has been successfully created.",
        });
      }
      router.refresh();
